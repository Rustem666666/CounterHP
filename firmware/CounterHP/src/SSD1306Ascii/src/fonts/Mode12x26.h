...
static const uint8_t Mode12x26[] PROGMEM = {
    0x03, 0x17, // size
    0x1A, // Максимальная ширина символа в пикселях = 26
    0x0C, // Высота шрифта в пикселях = 12
    0x30, // Первый символ в наборе (ASCII код) = '0' (0x30 = 48)
    0x05, // Количество символов в шрифте = 5
